...
interface PrivateDocument {
  ...
  type: 'contract' | 'certificate' | 'work-history' | 'nda' | 'evaluation' | 'company-cert';
}
  ...
  return (
    <div className="private-documents-container">
      <div className="private-documents-header">
        ...
        <p className="private-documents-subtitle">Tu documentación personal y confidencial</p>
      </div>
      ...
      <div className="private-documents-content">
        ...
        <div className="protected-section">
          ...
          <div className="protected-content">
            ...
            <p className="protected-text">
              Estos documentos son privados y solo tú puedes acceder a ellos. Se almacenan de forma segura.
            </p>
          </div>
        </div>
              ...
              <div className="private-document-item-content">
                ...
                <div className="private-document-item-footer">
                  ...
                  <div className="private-document-item-actions">
                    <button 
                      className="private-document-action-btn document-view-btn"
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <circle cx="12" cy="12" r="3"/>
                                            ...
                                            <span className="private-document-action-btn-names">Ver</span>
                    ...
                    >
                      ...
                      <span className="private-document-action-btn-names">Descargar</span>
                    </button>
                  </div>
                </div>
              </div>
        ...
        <div className="request-section">
          ...
          <div className="request-content">
            <h3 className="request-title">¿Necesitas un documento adicional?</h3>
